...
const QandaForum: React.FC<QandaForumProps> = ({}) => {
  ...
  return (
    <div className={styles["qanda-container"]}>
            ...
            <div className={styles.question}>
              ...
              <div className={styles["question-info"]}>
                <div className={styles["question-content"]}>
                  ...
                  <p>
                    Byggde detta projekt för att lära mig mer inom
                    webbutveckling. Planen var att bygga nåt variant av
                    stackoverflow inte direkt en klon. Taggarna som används i
                    toppen av frågan är länkar till respektive hemsida. Detta
                    projekt är byggt med Next.js, MongoDB, Mongoose, NextAuth.js
                    och SCSS för styling. Detta projekt är inte helt färdigt och
                    kommer att uppdateras med nya funktioner och förbättringar.
                  </p>
                </div>
